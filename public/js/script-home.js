document.addEventListener('DOMContentLoaded', () => {
  ...
  showMoreBtn.addEventListener('click', e => {
      e.preventDefault();
      displayRecipes(filteredRecipes.length > 0 ? filteredRecipes.slice(0, recipesPerPage) : allRecipes.slice(0, recipesPerPage));
      showMoreBtn.style.display = 'none';
      setupPagination(filteredRecipes.length > 0 ? filteredRecipes : allRecipes);
  });
